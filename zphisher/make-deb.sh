...
Maintainer: @mehdi
Depends: ${_depend}
Homepage: is just for me
Description: An automated phishing tool with 30+ templates. This Tool is made for not educational purpose only !
CONTROL_EOF
